...
![LinkedIn Status](https://img.shields.io/badge/LinkedIn%20Impressions-5K+-blue?style=flat&logo=linkedin)
![Achievements](https://img.shields.io/badge/1st_PlaceAI%20Competitions-Winner%20🏆-orange)
<br>
...
![LangChain](https://img.shields.io/badge/LangChain-2B2D42?style=flat&logo=openai&logoColor=white)
...
![RAG](https://img.shields.io/badge/RAG%20Pipelines-007ACC?style=flat&logo=semanticweb&logoColor=white)
...
class AboutMe:
    def __init__(self):
        ...
        self.ai_frameworks = ["PyTorch", "TensorFlow", "LangChain", "FastAPI", "RAG"]
        self.data_skills = ["Pandas", "NumPy", "Scikit-learn", "Data Scraping", "Data Analysis"]
...
<a href="https://github.com/adam-t-z"><img src="https://img.shields.io/badge/GitHub-100000?style=flat&logo=github&logoColor=white" /></a>
</p>
